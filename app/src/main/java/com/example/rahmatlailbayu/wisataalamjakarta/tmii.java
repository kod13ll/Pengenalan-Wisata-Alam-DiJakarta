...
public class tmii extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tmii);
    ...
    private void setupSliderOfline() {
        ...
        fragments.add(FragmentSlider.newInstance("mini1"));
        fragments.add(FragmentSlider.newInstance("mini2"));
        fragments.add(FragmentSlider.newInstance("mini3"));
