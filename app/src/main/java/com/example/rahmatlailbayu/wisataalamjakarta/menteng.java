...
public class menteng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menteng);
    ...
    private void setupSliderOfline() {
        ...
        fragments.add(FragmentSlider.newInstance("menteng1"));
        fragments.add(FragmentSlider.newInstance("menteng2"));
        fragments.add(FragmentSlider.newInstance("menteng3"));
