...
public class ecopark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecopark);
    ...
    private void setupSliderOfline() {
        ...
        fragments.add(FragmentSlider.newInstance("ecopark1"));
        fragments.add(FragmentSlider.newInstance("ecopark2"));
        fragments.add(FragmentSlider.newInstance("ecopark3"));
