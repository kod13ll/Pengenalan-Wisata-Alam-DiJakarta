...
public class tidung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tidung);
    ...
    private void setupSliderOfline() {
        ...
        fragments.add(FragmentSlider.newInstance("tidung1"));
        fragments.add(FragmentSlider.newInstance("tidung2"));
        fragments.add(FragmentSlider.newInstance("tidung3"));
