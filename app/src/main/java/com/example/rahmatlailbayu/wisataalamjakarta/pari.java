...
public class pari extends AppCompatActivity {
    ...
    private void setupSliderOfline() {
        ...
        fragments.add(FragmentSlider.newInstance("pari1"));
        fragments.add(FragmentSlider.newInstance("pari2"));
        fragments.add(FragmentSlider.newInstance("pari3"));
