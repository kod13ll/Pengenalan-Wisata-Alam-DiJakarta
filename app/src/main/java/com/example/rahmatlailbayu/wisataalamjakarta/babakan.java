...
public class babakan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_babakan);
    ...
    private void setupSliderOfline() {
        ...
        fragments.add(FragmentSlider.newInstance("babakan1"));
        fragments.add(FragmentSlider.newInstance("babakan2"));
        fragments.add(FragmentSlider.newInstance("babakan3"));
