...
public class mangrove extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mangrove);
    ...
    private void setupSliderOfline() {
        ...
        fragments.add(FragmentSlider.newInstance("mangrove1"));
        fragments.add(FragmentSlider.newInstance("mangrove2"));
        fragments.add(FragmentSlider.newInstance("mangrove3"));
